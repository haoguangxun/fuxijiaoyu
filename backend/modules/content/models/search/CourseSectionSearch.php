...
/**
 * CourseSectionSearch represents the model behind the search form about `backend\modules\content\models\CourseSection`.
 */
class CourseSectionSearch extends CourseSection
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'subtitle', 'video', 'url', 'template'], 'safe'],
        ];
    }
