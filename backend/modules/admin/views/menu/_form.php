...
$opts = Json::htmlEncode([
        'menus' => AdminMenu::getMenuSource(),
        'routes' => AdminMenu::getSavedRoutes(),
    ]);
...
<div class="menu-form">
    ...
    <div class="form-group">
        <?=
        Html::submitButton($model->isNewRecord ? Yii::t('rbac-admin', '添加') : Yii::t('rbac-admin', '修改'), ['class' => $model->isNewRecord
