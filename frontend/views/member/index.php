...
<div class="personal-form">
	...
	<div class="personal-form-item">
		...
		<textarea onKeyUp="javascript:checkWord(this);" onMouseDown="javascript:checkWord(this);" name="hobby"><?=$data_model['hobby']?></textarea>
		<div class="surplus">还可以输入<span id="wordCheck">200</span>个字符 </div>
	</div>
